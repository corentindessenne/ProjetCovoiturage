...
<?php
    include 'Connexion.php';        //on se connecte a la base de donnée
                    ...
                    if($conn->query($sql) === TRUE){
                        ...
                        if($conn->query($sql) === TRUE){
                            ...
                            if($conn->query($sql) === TRUE){
                                ...
                                }                                                               //requetes ont été effectuées avec succès
                                else{
                                    echo "Le changement de la Latitude Arrivée ne s'est pas effectué";
                                }
                            }
                            else{
                                echo "Le changement de la Latitude Départ ne s'est pas effectué";               //on affiche la/les requetes qui ont échoués
                            }
                        }
                        else{
