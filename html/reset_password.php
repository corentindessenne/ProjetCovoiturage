                    ...
                    <form action="reset_password_action.php" method="post">
                        ...
                        <div class="input-group">
                            <div class="item">
                                ...
                                <input type="password" required="required" name="newPassword" id="password_1"
                                       pattern="(?=.*\d)(?=.*[\W_])(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                       title="Ton mot de passe doit contenir au moins 8 caractères, dont au moins 1 minuscule, 1 majuscule et 1 caractère spécial"
                                       onkeyup='check();'>
                            </div>
                            <div class="item">
                                <label for="password_2">Confirmation</label>
                                <input type="password" required placeholder="" id="password_2" name="confirmPassword"
                                       onkeyup='check();'>
                            </div>
                        </div>
                        <span id='message'></span>
                        <br/>
                        <button type="submit" name="resetPassword" id="reset-btn">Réinitialiser</button>
                    </form>
                    <!-- Instruction -->
                    <div class="rules">
