   ...
   <form action="ActionDemandeAjout.php" method="post" id="traveler" class="form-example">
    <div class="form-traveler">
      <div class="radio-but">
       <label class="form-control" class="active">
        <input type="radio"  name="aller-retour" id="aller" value="a_to_r" checked='checked' />
        <span> ALLER</span>
      </label>

      <label class="form-control">
        <input type="radio" name="aller-retour" id="retour" value="r_to_a"/>
        <span> RETOUR </span>
      </label>
    </div>
    <label for="departure">
    ...
    <label>
      <div class="form-item">
        ...
        <input value="1" min="1" step="1" max="7" type="number" name="nbPass">
      </div>
    </label>
    <input class="inp-cbx" id="cbx" type="checkbox" name="tel" style="display: none;"/>
