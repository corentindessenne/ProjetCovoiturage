...
if(isset($_POST["password-reset"]) && $_POST["email"]){
    ...
    if($row){
        ...
        $link = "<a href='localhost/Plateforme covoiturage/html/reset_password.php?key=".$email."&token=".$token."' target='_blank' style='font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid; display: inline-block;'>Réinitialise ton mot de passe</a>";
