...
<html lang="fr">
<head>
    <title>Ton trajet a bien été supprimé - LBR Covoiturage</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">On te confirme que ton trajet a bien été supprimé. Nous avons également averti les passagers de ton trajet.</p>
                    </td>
                </tr>
                <!-- COPY -->
                <tr>
