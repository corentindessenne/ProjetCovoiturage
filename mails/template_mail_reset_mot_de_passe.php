            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 48px; font-weight: 400; margin: 0;">Tu as oublié ton mot de passe ?</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">Pas de panique : c'est super simple de réinitialiser ton mot de passe. Appuie sur le bouton ci-dessous et suis les instructions.</p>
                    </td>
                </tr>
                <!-- BULLETPROOF BUTTON -->
                <tr>
