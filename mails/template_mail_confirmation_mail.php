...
<html lang="fr">
<head>
    <title>Confirme ton adresse mail - LBR Covoiturage</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 48px; font-weight: 400; margin: 0;">Bienvenue {{Prenom}}!</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">Merci d'avoir rejoint la plateforme de covoiturage des Briques Rouges.
                            D'abord, appuie sur le bouton ci-dessous pour confirmer ton adresse mail.</p>
                    </td>
                </tr>
                <!-- BULLETPROOF BUTTON -->
                <tr>
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0; text-align: justify;">Si le bouton ne fonctionne pas, copie le lien
                            ci-dessous dans ton navigateur préféré :</p>
                    </td>
                </tr>
                <!-- COPY -->
                <tr>
